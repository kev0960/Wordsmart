/****************************************************************************
** Meta object code from reading C++ file 'def_notify.h'
**
...
#error "The header file 'def_notify.h' doesn't include <QObject>."
...
void Notify::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Notify::closed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Notify::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Notify.data,
